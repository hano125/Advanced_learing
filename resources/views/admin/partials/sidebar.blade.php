        ...
        <ul class="mb-2 navbar-nav flex-fill w-100">
            <li class="nav-item dropdown">
                ...
                <ul class="pl-4 collapse list-unstyled w-100" id="dashboard">
                    ...
                    <li class="nav-item">
                        <a class="pl-3 nav-link" href="./dashboard-analytics.html"><span
                                class="ml-1 item-text">Analytics</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="pl-3 nav-link" href="./dashboard-sales.html"><span
                                class="ml-1 item-text">E-commerce</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="pl-3 nav-link" href="./dashboard-saas.html"><span class="ml-1 item-text">Saas
                                Dashboard</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="pl-3 nav-link" href="./dashboard-system.html"><span
        ...
        <ul class="mb-2 navbar-nav flex-fill w-100">
            <li class="nav-item dropdown">
                ...
                <ul class="pl-4 collapse list-unstyled w-100" id="ui-elements">
                    <li class="nav-item">
                        <a class="pl-3 nav-link" href="./ui-color.html"><span class="ml-1 item-text">Colors</span>
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="pl-3 nav-link" href="./ui-icons.html"><span class="ml-1 item-text">Icons</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="pl-3 nav-link" href="./ui-buttons.html"><span
                                class="ml-1 item-text">Buttons</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="pl-3 nav-link" href="./ui-notification.html"><span
                                class="ml-1 item-text">Notifications</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="pl-3 nav-link" href="./ui-modals.html"><span class="ml-1 item-text">Modals</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="pl-3 nav-link" href="./ui-tabs-accordion.html"><span class="ml-1 item-text">Tabs &
                                Accordion</span></a>
                    </li>
                    <li class="nav-item">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="pl-4 collapse list-unstyled w-100" id="forms">
                    <li class="nav-item">
                        <a class="pl-3 nav-link" href="./form_elements.html"><span class="ml-1 item-text">Basic
                                Elements</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="pl-3 nav-link" href="./form_advanced.html"><span class="ml-1 item-text">Advanced
                                Elements</span></a>
                    </li>
                    <li class="nav-item">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="pl-4 collapse list-unstyled w-100" id="tables">
                    ...
                    <li class="nav-item">
                        <a class="pl-3 nav-link" href="./table_advanced.html"><span class="ml-1 item-text">Advanced
                                Tables</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="pl-3 nav-link" href="./table_datatables.html"><span class="ml-1 item-text">Data
                                Tables</span></a>
                    </li>
                </ul>
            </li>
            <li class="nav-item dropdown">
                ...
                <ul class="pl-4 collapse list-unstyled w-100" id="charts">
                    <li class="nav-item">
                        <a class="pl-3 nav-link" href="./chart-inline.html"><span class="ml-1 item-text">Inline
                                Chart</span></a>
                    </li>
                    <li class="nav-item">
        ...
        <ul class="mb-2 navbar-nav flex-fill w-100">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="pl-4 collapse list-unstyled w-100" id="profile">
                    ...
                    <a class="pl-3 nav-link" href="./profile-settings.html"><span class="ml-1">Settings</span></a>
                    <a class="pl-3 nav-link" href="./profile-security.html"><span class="ml-1">Security</span></a>
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="pl-4 collapse list-unstyled w-100" id="support">
                    <a class="pl-3 nav-link" href="./support-center.html"><span class="ml-1">Home</span></a>
                    <a class="pl-3 nav-link" href="./support-tickets.html"><span class="ml-1">Tickets</span></a>
        ...
        <ul class="mb-2 navbar-nav flex-fill w-100">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="pl-4 collapse list-unstyled w-100" id="auth">
                    ...
                    <a class="pl-3 nav-link" href="./auth-login-half.html"><span class="ml-1">Login
                            2</span></a>
                    <a class="pl-3 nav-link" href="./auth-register.html"><span class="ml-1">Register</span></a>
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="pl-4 collapse list-unstyled w-100" id="layouts">
                    ...
                    <li class="nav-item">
                        <a class="pl-3 nav-link" href="./index-horizontal.html"><span class="ml-1 item-text">Top
                                Navigation</span></a>
                    </li>
                    <li class="nav-item">
